...
uint32_t SerialVCP::available() { return in.getAvailable(); }

void SerialVCP::flushRX() { in.init(); }
 ...
 */
uint8_t SerialVCP::read() { return in.getByte(); }
...
inline void SerialVCP::enableTx() { vcp_send_cmplt_cb(); }
