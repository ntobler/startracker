...
from typing import Dict, Optional, Tuple, Sequence, Type
...
def gen_code_with_dependencies(
    messages: Sequence[Type[Message]], h_file: pathlib.Path, indent: int = 4
):
    ...
    with open(h_file, "w") as f:
        ...
        f.write(f"#ifndef {name}_H_\n")
        f.write(f"#define {name}_H_\n")
        f.write("\n")
